...
server.registerTool(
  "save_generated_image",
  {
    ...
    description:
      "Persist the exact image file generated by ChatGPT in a SeniorStudio project. Call this after ChatGPT image generation succeeds.",
...
server.registerTool(
  "save_edited_image",
  {
    ...
    description:
      "Persist the exact image file edited by ChatGPT as an immutable child version of a SeniorStudio asset.",
    inputSchema: z.object({
      asset_id: z.string().uuid(),
